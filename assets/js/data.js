...
//    госаккредитация.
//
// Проверено и НЕ добавлено 2026-09-14: Gerchik & Co — Банк России включил
// компанию (и связанное юрлицо J.B. FINANCE LLP) в список предупреждений
// как нелегального участника рынка ценных бумаг (cbr.ru/eng/inside/
// warning-list/detail/?id=7372, внесено 01.02.2021, обновлено 01.10.2024)
// — жёсткий критерий отбора не пройден, обсуждению не подлежит независимо
// от остальных показателей. Дополнительно: всего 11 отзывов на Trustpilot
// (при этом 3.8/5) — недостаточно данных, чтобы судить о репутации;
// регуляция только офшорная (Vanuatu FSC, Mauritius FSC); проп-программа
// запущена только в 2024. Не возвращать без снятия записи ЦБ.
//
